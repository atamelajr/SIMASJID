...
(1, 'ITM-AST-01', 'Sound System Yamaha Mixer & Speaker', 'Aset', 10, 'Peralatan', 'Set pengeras suara utama masjid'),
(2, 'ITM-AST-02', 'AC Split 2 PK Daikin', 'Aset', 1, 'Peralatan', 'Air Conditioner ruang utama sholat'),
(3, 'ITM-AST-03', 'Karpet Sajadah Roll Karaba', 'Aset', 7, 'Peralatan', 'Karpet sajadah sholat jamaah'),
(4, 'ITM-AST-04', 'Mimbar Kayu Jati Ukir', 'Aset', 1, 'Peralatan', 'Mimbar khutbah jumat'),
(5, 'ITM-MAT-01', 'Semen Gresik 50kg', 'Material', 2, 'Pembangunan', 'Semen Portland untuk pengecoran & dinding'),
(6, 'ITM-MAT-02', 'Pasir Pasang Hitam', 'Material', 1, 'Pembangunan', 'Pasir cor & pasang bata'),
(7, 'ITM-MAT-03', 'Cat Tembok Dulux White 20L', 'Material', 5, 'Pembangunan', 'Cat pelapis dinding luar/dalam'),
(8, 'ITM-MAT-04', 'Sabun Pembersih Karpet & Pel', 'Material', 8, 'Operasional', 'Pembersih lantai & karpet harian'),
(9, 'ITM-MAT-05', 'Alat Pel Gagang Stainless', 'Material', 1, 'Operasional', 'Perlengkapan alat pel masjid')
ON DUPLICATE KEY UPDATE name=VALUES(name);
